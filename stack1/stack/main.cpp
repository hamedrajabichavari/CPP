...
int main() {
    ...
    std::cout << "the name of cat is " << fluffy.name << std::endl;
    std::cout << "the color of cat is " << fluffy.color << std::endl;
    std::cout << "the weight of cat is " << fluffy.weight << "lb" << std::endl;
    std::cout << "the health of cat is " << fluffy.health << std::endl;
    std::cout << "is this a single cat? " << std::boolalpha << fluffy.single << std::endl;
